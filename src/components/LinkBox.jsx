  ...
  return (
    <div className="p-6 max-w-md mx-auto rounded-lg space-y-6">
      ...
      <input
        ...
        className="w-full py-2 border rounded focus:outline-none focus:ring-2 focus:ring-slate-700 transition duration-100"
      />
      <div className="mt-4">
        <button
          onClick={addItem}
          className="rounded-lg w-full py-2 transition duration-100"
        >
          Add Item
        </button>
      </div>
        ...
        {Array.from(blockedSites).map((site, index) => (
          ...
          >
            ...
            <button
              ...
              className="rounded-full transition duration-100"
            >
              X
            </button>
          </li>
